...
class MyLeague(League):
    ...
    def _scoreboard_request(self, week):
        params = {"view": "mScoreboard", "scoringPeriodId": week}
    ...
    def _get_all_rosters_in_schedule(self):
        ...
        roster_key = (
            ...
            if self.year <= 2017
            else "rosterForCurrentScoringPeriod"
        )
    ...
    def dump_league_data(self, integrity=False):
        ...
        for k, v in p_map.items():
            players.append({"espn_player_name": k, "position": None, "espn_id": v})
        ...
        for pick in self.draft:
            ...
            temp = {
                ...
                "pick_number": (
                    ((pick.round_num - 1) * self.settings.team_count) + pick.round_pick
                ),
